...
@property (nonatomic, strong) UIViewController *rtmpServerVC;
@property (nonatomic, strong) UIViewController *rtmpPublisherVC;
@property (nonatomic, strong) UIViewController *rtmpPlayerVC;
